...
from deep_research.core.schemas import CoverageMatrix, EvidenceCard, ResearchPlan, ResearchBranch, SourceRecordV2
from deep_research.core.settings import Settings
from deep_research.evidence.source_validation import content_terms
from deep_research.synthesis.synthesis_formatting import _coverage_repair_labels, _criteria_rich_plan, _report_subject
...
def _normalize_report_markdown(report: str, sources: list[SourceRecordV2], *, citations_enabled: bool = True) -> str:
    ...
    if not citations_enabled:
        # No citations exist yet on this pass -- the citation agent adds its own
        # Sources section after inserting [N] markers. Stamping one here would
        # just be duplicated and immediately overwritten.
