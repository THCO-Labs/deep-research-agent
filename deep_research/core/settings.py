...
class Settings:
    ...
    race_self_judge_enabled: bool = False
    section_batch_judge_enabled: bool = False
    ...
    azure_openai_api_version: str = field(default="2024-08-01-preview", repr=False)
    ...
    def from_env(
        ...
        *,
        ...
        settings = cls(
            ...
            race_self_judge_enabled=_resolve_bool(
                None,
                os.environ.get("DEEP_RESEARCH_RACE_SELF_JUDGE"),
                default=False,
            ),
            section_batch_judge_enabled=_resolve_bool(
                None,
                os.environ.get("DEEP_RESEARCH_SECTION_BATCH_JUDGE"),
                default=False,
            ),
            two_pass_synthesis_enabled=_resolve_bool(
                None,
                os.environ.get("DEEP_RESEARCH_TWO_PASS_SYNTHESIS"),
                default=True,
            ),
            ...
            azure_openai_api_version=os.environ.get("AZURE_OPENAI_API_VERSION", "2024-08-01-preview").strip()
