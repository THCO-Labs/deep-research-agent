...
Canonical URL: https://aws.amazon.com/what-is/quantum-computing
Branch: branch_1
...
* [What is Quantum computing?](#what-is-quantum-computing--1achfkc)
* [What is the quantum computing advantage?](#what-is-the-quantum-computing-advantage--1achfkc)
* [What is quantum mechanics?](#what-is-quantum-mechanics--1achfkc)
* [What is a qubit?](#what-is-a-qubit--1achfkc)
* [What are the principles of quantum computing?](#what-are-the-principles-of-quantum-computing--1achfkc)
* [What are the components of a quantum computer?](#what-are-the-components-of-a-quantum-computer--1achfkc)
* [What are the types of quantum technology?](#what-are-the-types-of-quantum-technology--1achfkc)
* [How do companies use quantum computing?](#how-do-companies-use-quantum-computing--1achfkc)
* [How can you get started with quantum computing?](#how-can-you-get-started-with-quantum-computing--1achfkc)
* [How can AWS help with quantum computing?](#how-can-aws-help-with-quantum-computing--1achfkc)

## What is Quantum computing?

Quantum computing is a multidisciplinary field comprising aspects of computer science, physics, and mathematics that utilizes quantum mechanics to solve complex problems faster than on classical computers. The field of quantum computing includes hardware research and application development. Quantum computers are able to solve certain types of problems faster than classical computers by taking advantage of quantum mechanical effects, such as superposition and quantum interference. Some applications where quantum computers can provide such a speed boost include [machine learning (ML)](/what-is/machine-learning/), optimization, and simulation of physical systems. Eventual use cases could be portfolio optimization in finance or the simulation of chemical systems, solving problems that are currently impossible for even the most powerful supercomputers on the market.
...
[Amazon Braket](/braket/) is a fully managed quantum computing service. It is designed to help speed up scientific research and software development for quantum computing. You can use Amazon Braket to do these tasks:
...
* Innovate quickly with expert guidance and tech support, or collaborate with consultants in the [Amazon Quantum Solutions Lab](/quantum-solutions-lab/).
* Push the boundaries of [quantum hardware research](/braket/quantum-computing-research/?pg=ln&sec=uc) with access to trapped ion, superconducting, photonic, and annealing devices.

Get started with quantum computing by creating an [AWS account](/free/compute/) today.

## AWS Quantum Computing Next Steps

[### Check out additional product-related resources

Learn more about Quantum Computing Services](/braket/)
