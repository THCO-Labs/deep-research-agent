...
Canonical URL: https://azure.microsoft.com/en-us/resources/cloud-computing-dictionary/what-is-quantum-computing
Branch: branch_1
...
![](https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/bg-acom-full-cylinder-01-seo-light?resMode=sharp2&op_usm=1.5,0.65,15,0&wid=4000&hei=1450&qlt=100&fit=constrain)
...
![](https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/bg-acom-fl-md-bf-all-5?resMode=sharp2&op_usm=1.5,0.65,15,0&wid=1600&hei=912&qlt=100&fmt=png-alpha&fit=constrain)
...
Quantum computing applies concepts from quantum mechanics to represent and process information differently than classical systems. Instead of relying only on bits that hold a single value, quantum systems use [qubits](https://azure.microsoft.com/en-us/resources/cloud-computing-dictionary/what-is-a-qubit) that can represent multiple possibilities at once. This structure allows teams to explore complex problems in new ways, especially when traditional approaches are too slow or impractical.
...
![gradient background](https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/bg-acom-fl-md-bf-all-5?resMode=sharp2&op_usm=1.5,0.65,15,0&qlt=85)

## Explore more computing resources

![](https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/ACOM-lifestyle9-2000-1125?resMode=sharp2&op_usm=1.5,0.65,15,0&wid=2000&hei=1590&qlt=100&fit=constrain)

### Discover Microsoft Azure

![](https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/ACOM-lifestyle13-2000-1125?resMode=sharp2&op_usm=1.5,0.65,15,0&wid=2000&hei=1590&qlt=100&fit=constrain)

### Learn how to run quantum programs on Azure Quantum

![](https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/ACOM-lifestyle12-2000-1125?resMode=sharp2&op_usm=1.5,0.65,15,0&wid=2000&hei=1590&qlt=100&fit=constrain)
...
### Who would need a quantum computer?

![](https://cdn-dynmedia-1.microsoft.com/is/content/microsoftcorp/acom_social_icon_azure)
![Twitter](https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/acom-icons-x-black-white-24x24?scl=1 "&nbsp;")
![Instagram](https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/acom-icons-instagram-black-white-24x24?scl=1 "&nbsp;")
![LinkedIn](https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/acom-icons-linkedIn-black-white-24x24?scl=1 "&nbsp;")
![YouTube](https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/acom-icons-youtube-black-white-24x24?scl=1 "&nbsp;")
